...
test("after typing search command without loading a file, the error output is printed", async ({
  ...
  await page.getByLabel("Command input").fill("search {name}{isaac yi}");
...
test("after typing search command with wrong number of inputs, the error output is printed", async ({
  ...
  await page
    ...
    .fill("search {babboey}{get}{rekt}{kid}");
  await button.click();
...
test("searching for data that doesn't exist in loaded CSV", async ({
  ...
  //load successfully
  await page.getByLabel("Command input").click();
  await page.getByLabel("Command input").fill("load_file emptyCSV.csv");
  ...
  //do the search
  await page.getByLabel("Command input").click();
  await page.getByLabel("Command input").fill("search {bro}");
  await button.click();
...
test("searching for valid tuple with no col identifier", async ({ page }) => {
  ...
  //load successfully
  await page.getByLabel("Command input").click();
  await page.getByLabel("Command input").fill("load_file mixedCSV.csv");
  ...
  //do the search
  await page.getByLabel("Command input").click();
  await page.getByLabel("Command input").fill("search {string}");
  await button.click();
...
test("searching for valid tuple, but isn't in the column given by index col identifier", async ({
  ...
  //do the search
  await page.getByLabel("Command input").click();
  await page.getByLabel("Command input").fill("search {2}{isaac yi}");
  await button.click();
...
test("searching for valid tuple with valid col index identifier", async ({
  ...
  //do the search
  await page.getByLabel("Command input").click();
  await page.getByLabel("Command input").fill("search {0}{isaac yi}");
  await button.click();
...
test("searching for valid tuple, but isn't in the column given by index name identifier", async ({
  ...
  //do the search
  await page.getByLabel("Command input").click();
  await page.getByLabel("Command input").fill("search {age}{isaac yi}");
  await button.click();
